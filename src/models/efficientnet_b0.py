"""
EfficientNet-B0 model for binary classification (fire vs. non-fire).

This module wraps torchvision's EfficientNet-B0 implementation and adapts the
...
class EfficientNetB0(nn.Module):
    """
    EfficientNet-B0 model adapted for binary classification.
    ...
    def __init__(
        ...
        Args:
            ...
            dropout: Optional dropout probability to use in the classifier
                     head. If None, uses the default from torchvision.
        """
        super().__init__()
        ...
        if dropout is not None:
            ...
            # Keep original dropout but replace final linear layer
